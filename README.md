...
- **9 أنماط تسمية** — S01E01, S01.E01, Season 01 Episode 01, EP 001, #01, الموسم 01 - الحلقة 01, S1E1, EP01 + قالب مخصص
- **قالب مخصص** — أنشئ صيغتك الخاصة بالرموز: `{show} {season} {ep} {ep2} {ep3}`
- **قائمة معاينة رسومية** — جدول يعرض الأسماء القديمة والجديدة مع ألوان الحالة، ويمكن تعديل الاسم الجديد بالنقر المزدوج
- **اختصارات لوحة المفاتيح** — Ctrl+R إعادة تسمية، Ctrl+E معاينة، Ctrl+Z تراجع، Ctrl+B تصفح
- **زر إيقاف** — أوقف عمليات المعالجة الطويلة في أي وقت
- **إشعار فوري** — إشعار Windows عند اكتمال عملية إعادة تسمية طويلة
- **أنماط الاستبعاد** — استبعد ملفات مثل sample / trailer من المعالجة
- **دعم الترجمة** — أعد تسمية ملفات الترجمة (.srt/.ass/.ssa/.sub) لتطابق الحلقات
- **تصدير/استيراد الإعدادات** — احفظ إعداداتك كملف JSON واسترجعها لاحقاً
...
| 8 | قالب مخصص (Custom...) | `{show} - S{season}E{ep3}` |
